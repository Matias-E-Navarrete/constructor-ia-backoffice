...
export default function Family() {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <h1 className="text-xl font-semibold text-slate-900">Familia</h1>
      ...
      <ul className="space-y-2">
        ...
        {memberships.length === 0 && <p className="text-slate-500 text-sm">Todavía no formás parte de un grupo familiar.</p>}
      </ul>

      {selected && (
        <div className="bg-white border border-slate-200 rounded-lg p-4">
          <h2 className="font-medium text-slate-800 mb-2">{selected.group.name}</h2>
