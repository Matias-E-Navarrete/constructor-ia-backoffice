...
export default function Finance() {
  ...
  return (
    <div className="max-w-2xl space-y-8">
      <div>
        <h1 className="text-xl font-semibold text-neutral-900 dark:text-neutral-50 mb-4">Finanzas</h1>
        ...
        <ul className="space-y-2">
          {transactions.map((t) => (
            <li key={t.id} className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-lg p-3 flex justify-between text-sm text-neutral-800 dark:text-neutral-200">
              <span>
                {t.category} {t.group_id && <span className="text-xs text-neutral-400 dark:text-neutral-500">(familia)</span>}
              </span>
      ...
      <div>
        <h2 className="text-lg font-semibold text-neutral-900 dark:text-neutral-50 mb-2">Resumen</h2>
